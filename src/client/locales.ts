...
export const zh = {
  ...
  'avatar.captain': '队长',
  'avatar.url': '图片 URL',
  'avatar.hint': '支持 PNG/JPEG/WebP，最大 {mb} MB；外链由本机安全代理加载。',
  'avatar.applyUrl': '使用 URL',
  'avatar.upload': '上传图片',
  'avatar.clear': '恢复默认',
  'avatar.close': '关闭',
  'avatar.saved': '头像已保存，面板与会话卡片将同步更新。',
  'avatar.failed': '头像更新失败',
  'avatar.urlRequired': '请输入 HTTP(S) 图片 URL。',
  'avatar.fileType': '只支持 PNG、JPEG 或 WebP 图片。',
  'avatar.fileTooLarge': '图片超过上传大小限制。',
...
export const en = {
  ...
  'avatar.target': 'Apply to',
  'avatar.captain': 'Captain',
  'avatar.url': 'Image URL',
  'avatar.hint': 'PNG/JPEG/WebP up to {mb} MB; remote images load through the local safety proxy.',
  'avatar.applyUrl': 'Use URL',
  'avatar.upload': 'Upload image',
  'avatar.clear': 'Restore default',
  'avatar.close': 'Close',
  'avatar.saved': 'Avatar saved; the panel and conversation card will update together.',
  'avatar.failed': 'Avatar update failed',
  'avatar.urlRequired': 'Enter an HTTP(S) image URL.',
  'avatar.fileType': 'Only PNG, JPEG, or WebP images are supported.',
  'avatar.fileTooLarge': 'The image exceeds the upload size limit.',
  'format.listSeparator': ', ',
