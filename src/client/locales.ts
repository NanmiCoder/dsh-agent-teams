...
export const zh = {
  ...
  'plan.badge': '待确认',
  'plan.title': '执行前计划审查',
  'plan.description': '成员尚未创建、任务尚未调度。可先调整模型、提示词与依赖关系，再确认启动。',
  'plan.member.role': '角色',
...
export const en = {
  ...
  'plan.description': 'Members have not been spawned and tasks have not been scheduled. Adjust routes, prompts, and dependencies before starting.',
  ...
  'plan.continue': 'Continue planning',
