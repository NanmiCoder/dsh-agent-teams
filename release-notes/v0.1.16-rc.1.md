# AgentTeams v0.1.16-rc.1 — candidate

This candidate restores team execution across the exact Harness targets `0.1.2-rc.1`, `0.1.2-alpha.5`, and `0.1.2-alpha.2`. It is prepared for the npm `next` channel. This file does not mean it has been published.
