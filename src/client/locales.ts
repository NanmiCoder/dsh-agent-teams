...
export const zh = {
  ...
  'activity.badgeLabel': '团队',
  'activity.subtitle.working': '{count} 名成员执行中',
  'activity.subtitle.staged': '计划等待确认',
  'activity.subtitle.stopped': '团队已停止',
  'activity.subtitle.waiting': '等待成员回报',
  'activity.subtitle.archived': '{count} 条历史记录',
  'activity.subtitle.stale': '连接中断，显示最近快照',
  'team.stop': '停止团队',
  'team.stopped': '已停止',
  ...
  'plan.task.dependencies': '前置任务',
  'plan.task.dependenciesHint': '点击选择必须先完成的任务；不得形成循环依赖',
  'plan.task.noOtherTasks': '暂无其他任务可作为前置',
...
export const en = {
  ...
  'activity.badgeLabel': 'Teams',
  'activity.subtitle.working': '{count} members working',
  'activity.subtitle.staged': 'Plan awaiting approval',
  'activity.subtitle.stopped': 'Team stopped',
  'activity.subtitle.waiting': 'Waiting for reports',
  'activity.subtitle.archived': '{count} archived records',
  'activity.subtitle.stale': 'Connection lost; showing last snapshot',
  'team.stop': 'Stop team',
  ...
  'plan.reviewTitle': '{team} · plan review',
  ...
  'plan.task.dependencies': 'Prerequisites',
  'plan.task.dependenciesHint': 'Pick the tasks that must finish first; cycles are rejected',
  'plan.task.noOtherTasks': 'No other tasks can be prerequisites yet',
